...
>
> Submit the URL of your forked GitHub repository to Moodle at [Exercise 3 submission](https://elearning.ulisboa.pt/mod/assign/view.php?id=630230). Do this only after you push your local repository to the remote GitHub repository. 
